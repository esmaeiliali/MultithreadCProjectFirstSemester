int sortbookmoalefjojesm (char a[], int count)
{
			FILE *fin = fopen("listketab.txt", "r+");
		if( fin == NULL )
		{
			cout << "sort kardane natayej ba moshkel roo be roo shode, lotfan egdam konid" ;
			return 0;
		}
	...
	for( k=0; k<count; k++ ) {
		...
		for (  kp=k+1; kp<count ; kp++) {
			fseek(fin, 0, SEEK_SET);
			fseek(fin, ((s[kp])* sizeof (struct ketabkhane)), SEEK_CUR); 
			fread( &list[1], sizeof(struct ketabkhane), 1,fin );
			if( strcmp( list[0].moalef, list[0].moalef2) > 0 )
					{
						strcpy( a, list[0].moalef );
						strcpy( list[0].moalef, list[0].moalef2 );
						strcpy( list[0].moalef2, a );
					}
			if( strcmp( list[0].moalef, list[0].moalef3) > 0 )
					{
						strcpy( a, list[0].moalef );
						strcpy( list[0].moalef, list[0].moalef3 );
						strcpy( list[0].moalef3, a );
					}
			if( strcmp( list[0].moalef, list[0].moalef4) > 0 )
					{
						strcpy( a, list[0].moalef );
						strcpy( list[0].moalef, list[0].moalef4 );
						strcpy( list[0].moalef4, a );
					}
			if( strcmp( list[0].moalef, list[0].moalef5) > 0 )
					{
						strcpy( a, list[0].moalef );
						strcpy( list[0].moalef, list[0].moalef5 );
						strcpy( list[0].moalef5, a );
					}
			if( strcmp( list[0].moalef2, list[0].moalef3) > 0 )
					{
						strcpy( a, list[0].moalef2 );
						strcpy( list[0].moalef2, list[0].moalef3 );
						strcpy( list[0].moalef3, a );
					}
			if( strcmp( list[0].moalef2, list[0].moalef4) > 0 )
					{
						strcpy( a, list[0].moalef2 );
						strcpy( list[0].moalef2, list[0].moalef4 );
						strcpy( list[0].moalef4, a );
					}
			if( strcmp( list[0].moalef2, list[0].moalef5) > 0 )
					{
						strcpy( a, list[0].moalef2 );
						strcpy( list[0].moalef2, list[0].moalef5 );
						strcpy( list[0].moalef5, a );
					}
			if( strcmp( list[0].moalef3, list[0].moalef4) > 0 )
					{
						strcpy( a, list[0].moalef3 );
						strcpy( list[0].moalef3, list[0].moalef4 );
						strcpy( list[0].moalef4, a );
					}
			if( strcmp( list[0].moalef3, list[0].moalef5) > 0 )
					{
						strcpy( a, list[0].moalef3 );
						strcpy( list[0].moalef3, list[0].moalef5 );
						strcpy( list[0].moalef5, a );
					}
			if( strcmp( list[0].moalef4, list[0].moalef5) > 0 )
					{
						strcpy( a, list[0].moalef4 );
						strcpy( list[0].moalef4, list[0].moalef5 );
						strcpy( list[0].moalef5, a );
					}
			if( strcmp( list[1].moalef, list[1].moalef2) > 0 )
					{
						strcpy( a, list[1].moalef );
						strcpy( list[1].moalef, list[1].moalef2 );
						strcpy( list[1].moalef2, a );
					}
			if( strcmp( list[1].moalef, list[1].moalef3) > 0 )
					{
						strcpy( a, list[1].moalef );
						strcpy( list[1].moalef, list[1].moalef3 );
						strcpy( list[1].moalef3, a );
					}
			if( strcmp( list[1].moalef, list[1].moalef4) > 0 )
					{
						strcpy( a, list[1].moalef );
						strcpy( list[1].moalef, list[1].moalef4 );
						strcpy( list[1].moalef4, a );
					}
			if( strcmp( list[1].moalef, list[1].moalef5) > 0 )
					{
						strcpy( a, list[1].moalef );
						strcpy( list[1].moalef, list[1].moalef5 );
						strcpy( list[1].moalef5, a );
					}
			if( strcmp( list[1].moalef2, list[1].moalef3) > 0 )
					{
						strcpy( a, list[1].moalef2 );
						strcpy( list[1].moalef2, list[1].moalef3 );
						strcpy( list[1].moalef3, a );
					}
			if( strcmp( list[1].moalef2, list[1].moalef4) > 0 )
					{
						strcpy( a, list[1].moalef2 );
						strcpy( list[1].moalef2, list[1].moalef4 );
						strcpy( list[1].moalef4, a );
					}
			if( strcmp( list[1].moalef2, list[1].moalef5) > 0 )
					{
						strcpy( a, list[1].moalef2 );
						strcpy( list[1].moalef2, list[1].moalef5 );
						strcpy( list[1].moalef5, a );
					}
			if( strcmp( list[1].moalef3, list[1].moalef4) > 0 )
					{
						strcpy( a, list[1].moalef3 );
						strcpy( list[1].moalef3, list[1].moalef4 );
						strcpy( list[1].moalef4, a );
					}
			if( strcmp( list[1].moalef3, list[1].moalef5) > 0 )
					{
						strcpy( a, list[1].moalef3 );
						strcpy( list[1].moalef3, list[1].moalef5 );
						strcpy( list[1].moalef5, a );
					}
			if( strcmp( list[1].moalef4, list[1].moalef5) > 0 )
					{
						strcpy( a, list[1].moalef4 );
						strcpy( list[1].moalef4, list[1].moalef5 );
						strcpy( list[1].moalef5, a );
					}
		if( strcmp( list[0].moalef, list[1].moalef ) > 0 )
		{
				strcpy( a, list[0].moalef );
	...
	for( k=0; k<count; k++ ) {
		...
		fwrite( &list[0], sizeof(struct ketabkhane), 1, fp );
				...
				cout << "name moalefeen ketab : " <<list[0].moalef << "\\" << list[0].moalef2 << "\\" << list[0].moalef3 << endl;
				cout <<  list[0].moalef4 << "\\" << list[0].moalef5 << endl ;
				cout << "noe ketab : " << list[0].type << endl;
				cout << "zabane ketab : " << list[0].zaban << endl;
				cout << "motarjemeen ketab : " << list[0].motarjem << "\\" << list[0].motarjem2 << "\\" << list[0].motarjem3 <<  endl;
				cout << list[4].motarjem << "\\" << list[0].motarjem5 << endl;
