int sortbookchapjojmotarjem (char a[], int count)
{
	char r[60];
	...
	int kp =0;
		...
		if( list[0].chap.year<list[1].chap.year || (list[0].chap.year<=list[1].chap.year &&  list[0].chap.month< list[1].chap.month) || (list[0].chap.year<=list[1].chap.year &&  list[0].chap.month<=list[1].chap.month && list[0].chap.day<list[1].chap.day ))
		{
				strcpy( r, list[0].moalef );
				strcpy( list[0].moalef, list[1].moalef );
				strcpy( list[1].moalef, r );

				strcpy( r, list[0].moalef2 );
				strcpy( list[0].moalef2, list[1].moalef2 );
				strcpy( list[1].moalef2, r );

				strcpy( r, list[0].moalef3 );
				strcpy( list[0].moalef3, list[1].moalef3 );
				strcpy( list[1].moalef3, r );

				strcpy( r, list[0].moalef4 );
				strcpy( list[0].moalef4, list[1].moalef4 );
				strcpy( list[1].moalef4, r );

				strcpy( r, list[0].moalef5 );
				strcpy( list[0].moalef5, list[1].moalef5 );
				strcpy( list[1].moalef5, r );

				strcpy( r, list[0].name );
				strcpy( list[0].name, list[0].name );
				strcpy( list[1].name, r );
				strcpy( r, list[0].zaban );
				strcpy( list[0].zaban, list[1].zaban );
				strcpy( list[1].zaban, r );
				strcpy( r, list[0].nasher );
				strcpy( list[0].nasher, list[1].nasher );
				strcpy( list[1].nasher, r );
				strcpy( r, list[0].motarjem );
				strcpy( list[0].motarjem, list[1].motarjem );
				strcpy( list[1].motarjem, r );

				strcpy( r, list[0].motarjem2 );
				strcpy( list[0].motarjem2, list[1].motarjem2 );
				strcpy( list[1].motarjem2, r );

				strcpy( r, list[0].motarjem3 );
				strcpy( list[0].motarjem3, list[1].motarjem3 );
				strcpy( list[1].motarjem3, r );

				strcpy( r, list[0].motarjem4 );
				strcpy( list[0].motarjem4, list[1].motarjem4 );
				strcpy( list[1].motarjem4, r );

				strcpy( r, list[0].motarjem5 );
				strcpy( list[0].motarjem5, list[1].motarjem5 );
				strcpy( list[1].motarjem5, r );

				strcpy( r, list[0].type );
				strcpy( list[0].type, list[1].type );
				strcpy( list[1].type, r );
				strcpy( r, list[0].keyfiyat );
				strcpy( list[0].keyfiyat, list[1].keyfiyat );
				strcpy( list[1].keyfiyat, r );
				strcpy( r, list[0].vazketab );
				strcpy( list[0].vazketab, list[1].vazketab );
				strcpy( list[1].vazketab, r );
				strcpy( r, list[0].shabak );
				strcpy( list[0].shabak, list[1].shabak );
				strcpy( list[1].shabak, r );
				strcpy( r, list[0].karbar );
				strcpy( list[0].karbar, list[1].karbar );
				strcpy( list[1].karbar, r );
				y = list[1].amanat.day ;
